...
| `emu-specs/ldm-layouts.md` | LDM offsets for col/row arrays |
| `emu-specs/niu.md` | `NOC_ID_LOGICAL` register, NIU config register map |
| `emu-specs/device-grid.md` | Grid topology, coordinate assignments |
