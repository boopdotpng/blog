...
On Blackhole, `OPERAND_START_STREAM = 0`, so CB N maps directly to stream N (streams 0–63). This is different from Wormhole where CB N maps to stream 8+N.

Source: `tt-metal/tt_metal/hw/inc/internal/tt-1xx/blackhole/stream_io_map.h`
