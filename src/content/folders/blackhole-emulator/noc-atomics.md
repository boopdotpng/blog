...
| Python emulator (atomics) | `blackhole-py/extra/emu/noc.py` |
| Python tests (atomics) | `blackhole-py/extra/emu/tests/test_noc.py` |
...
| NIU emulator spec | `emu-specs/niu.md` |
| Existing INCR_GET docs | `emu-specs/niu.md` §13 (Atomic Operations) |
