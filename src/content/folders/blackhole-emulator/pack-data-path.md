...
```
Bit 31..24  23     22..21       20     19..18  17..16     15..14      13     12
──────────  ─────  ──────────   ────   ──────  ─────────  ─────────   ────   ────
 opcode     Last   CfgContext   Flush  Concat  CtxtCtrl   OvrdThrdId  (rsvd) ZeroWrite
                                                                                       
Bit 11..8      7        6..5      4..3    2..1    0
──────────  ──────   ─────────  ──────  ──────  ────────────────────
ReadIntfSel DstAccMode AddrMode  AddrCntContext  RowPadZero
```
